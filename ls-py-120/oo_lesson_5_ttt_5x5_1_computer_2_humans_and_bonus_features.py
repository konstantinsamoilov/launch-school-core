...
class Computer(Player):
    def __init__(self, marker):
        super().__init__(marker, "Computer")
...
class TTTGame:
    ...
    def __init__(self):
        ...
        self.human1 = Human(markers.pop(), "Human 1")
        self.human2 = Human(markers.pop(), "Human 2")
        self.computer = Computer(markers.pop())

        self.players = [self.human1, self.human2, self.computer]
    ...
    def display_score(self):
        print(f'Human 1: {self.human1.score}. Human 2: {self.human2.score}. Computer: {self.computer.score}.')
    ...
    def get_opponents(self, computer):
        return [p for p in self.players if p != computer]
