...
class WheeledVehicle(StatsMixin):
    def __init__(self,
                 tire_list,
...
print(motorboat.fuel_efficiency) # 5.5
print(motorboat.fuel_capacity) # 100
print(motorboat.range()) # 560.0